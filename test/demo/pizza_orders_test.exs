defmodule Demo.PizzaOrdersTest do
  use Demo.DataCase

  alias Demo.PizzaOrders

  describe "pizzaorders" do
    alias Demo.PizzaOrders.PizzaOrder

    import Demo.PizzaOrdersFixtures

    @invalid_attrs %{username: nil, pizza: nil}

    test "list_pizzaorders/0 returns all pizzaorders" do
      pizza_order = pizza_order_fixture()
      assert PizzaOrders.list_pizzaorders() == [pizza_order]
    end
