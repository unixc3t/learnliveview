defmodule Demo.VolunteersTest do
  use Demo.DataCase
  ...
  describe "volunteers" do
    ...
    import Demo.VolunteersFixtures

    @invalid_attrs %{name: nil, phone: nil, check_out: nil}
    ...
    test "create_volunteer/1 with valid data creates a volunteer" do
      valid_attrs = %{name: "some name", phone: "some phone", check_out: true}
      ...
      assert volunteer.check_out == true
    end
    ...
    test "update_volunteer/2 with valid data updates the volunteer" do
      volunteer = volunteer_fixture()
      update_attrs = %{name: "some updated name", phone: "some updated phone", check_out: false}
      ...
      assert volunteer.check_out == false
    end
